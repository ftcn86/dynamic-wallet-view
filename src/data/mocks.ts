...
export const mockTransactions: Transaction[] = [
  { id: 'tx001', date: subDays(today, 2).toISOString(), type: 'received', amount: 150.75, status: 'completed', from: 'Fiona Coin', description: 'Project collaboration', blockExplorerUrl: 'https://blockexplorer.minepi.com/testnet/transactions/7a7ed20d3d72c365b9019baf8dc4c4e3cce4c08114d866e47ae157e3a796e9e7' },
  { id: 'tx002', date: subDays(today, 3).toISOString(), type: 'sent', amount: 50.00, status: 'completed', to: 'Bob Miner', description: 'Team bonus', blockExplorerUrl: 'https://blockexplorer.minepi.com/testnet/transactions/8b8fe21e4e83d476c0120cbf9ed5d5f4ddf5d19225e977f58bf268f4b8a7fa8' },
  { id: 'tx003', date: subDays(today, 5).toISOString(), type: 'mining_reward', amount: 6.0288, status: 'completed', description: 'Daily mining reward', blockExplorerUrl: 'https://blockexplorer.minepi.com/testnet/transactions/9c9fg32f5f94e587d1231dcg0fe6e6g5eef6e2a336f088g69cg379g5b9b8gb9' },
  { id: 'tx004', date: subDays(today, 7).toISOString(), type: 'node_bonus', amount: 12.5, status: 'completed', description: 'Weekly node operation bonus', blockExplorerUrl: 'https://blockexplorer.minepi.com/testnet/transactions/0d0gh43g6g05f698e2342edh1gf7f7h6ffg7f3b447g99h7dh480h6c0c9hc0' },
  { id: 'tx005', date: subDays(today, 10).toISOString(), type: 'sent', amount: 10.00, status: 'completed', to: 'Support Fund', description: 'Donation', blockExplorerUrl: 'https://blockexplorer.minepi.com/testnet/transactions/1e1hi54h7h16g709f3453fei2hg8g8i7ggh8g4c558h00i8ei591i7d1d0id1' },
  { id: 'tx006', date: subDays(today, 12).toISOString(), type: 'received', amount: 200.00, status: 'completed', from: 'Hannah Block', description: 'Marketplace sale', blockExplorerUrl: 'https://blockexplorer.minepi.com/testnet/transactions/2f2ij65i8i27h810g4564gfj3ih9h9j8hhi9h5d669i11jfj602j8e2e1je2' },
  { id: 'tx007', date: subDays(today, 15).toISOString(), type: 'mining_reward', amount: 6.0288, status: 'completed', description: 'Daily mining reward', blockExplorerUrl: 'https://blockexplorer.minepi.com/testnet/transactions/3g3jk76j9j38i921h5675hgk4ji0i0k9iij0i6e770j22kgkg713k9f3f2kf3' },
  { id: 'tx008', date: subDays(today, 18).toISOString(), type: 'sent', amount: 5.00, status: 'failed', to: 'InvalidUser', description: 'Test transaction', blockExplorerUrl: 'https://blockexplorer.minepi.com/testnet/transactions/4h4kl87k0k49j032i6786ihl5kj1j1l0jjk1j7f881k33lhlh824l0g4g3lg4' },
];
